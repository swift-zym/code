...
int cao=3,jijiubao=2,baiyao=2,superbaiyao=6,boom=3,dubiao=2,atom_boom=20;
    ...
    switch(scanf("%d",&choose_number),choose_number)
    {
        ...
        case 7:
            if(battle) //在战斗中(battle=1),否则(battle=0)不能使用攻击性物品
            {
                if(atom_boom>0)
                {
                    SlowDisplay("使用手抛式原子弹,敌人HP减少2000\n\n\n");
                    atom_boom--;
                    guai.health-=2000;
                    AttackResult();
                }
...
default:
            ...
            case 3: //对话选项
                ...
                {
                    SlowDisplay("要和谁说话?\n\n\n1,红发女郎 2,赏金猎人 3,酒吧老板 4,小商店服务员"); //显示对话人物
                    switch(scanf("%d",&choose_number),choose_number)
                    {
                        case 1:
...
default: SlowDisplay("输入错误\n\n\n");
                        ...
                        case 4:
							printf("您要买点什么？这里面有盔甲和武器，进去输入1 返回输入0\n\n\n");
							long long tmpmp=1;
							while(tmpmp)
							{
								printf("您要什么？1,布甲100元 2,铁甲150元 3,银甲200元 4,黄金圣衣500元 5,匕首100元 6,长剑150元 7,碧血剑200元 8,绝世好剑500元 0,返回");
								switch(scanf("%d",&choose_number),choose_number)
                                {
                                    case 1:
                                        if(money<100)
